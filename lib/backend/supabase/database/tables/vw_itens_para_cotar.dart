...
class VwItensParaCotarTable extends SupabaseTable<VwItensParaCotarRow> {
  @override
  String get tableName => 'vw_itens_para_cotar';

  @override
  VwItensParaCotarRow createRow(Map<String, dynamic> data) =>
      VwItensParaCotarRow(data);
}

class VwItensParaCotarRow extends SupabaseDataRow {
  VwItensParaCotarRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VwItensParaCotarTable();
