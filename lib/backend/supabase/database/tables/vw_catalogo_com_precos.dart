...
class VwCatalogoComPrecosTable extends SupabaseTable<VwCatalogoComPrecosRow> {
  @override
  String get tableName => 'vw_catalogo_com_precos';

  @override
  VwCatalogoComPrecosRow createRow(Map<String, dynamic> data) =>
      VwCatalogoComPrecosRow(data);
}

class VwCatalogoComPrecosRow extends SupabaseDataRow {
  VwCatalogoComPrecosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VwCatalogoComPrecosTable();
