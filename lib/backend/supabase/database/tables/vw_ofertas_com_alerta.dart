...
class VwOfertasComAlertaTable extends SupabaseTable<VwOfertasComAlertaRow> {
  @override
  String get tableName => 'vw_ofertas_com_alerta';

  @override
  VwOfertasComAlertaRow createRow(Map<String, dynamic> data) =>
      VwOfertasComAlertaRow(data);
}

class VwOfertasComAlertaRow extends SupabaseDataRow {
  VwOfertasComAlertaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VwOfertasComAlertaTable();
