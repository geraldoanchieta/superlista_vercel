...
class VwDetalhesItensSolicitadosTable
    extends SupabaseTable<VwDetalhesItensSolicitadosRow> {
  @override
  String get tableName => 'vw_detalhes_itens_solicitados';

  @override
  VwDetalhesItensSolicitadosRow createRow(Map<String, dynamic> data) =>
      VwDetalhesItensSolicitadosRow(data);
}

class VwDetalhesItensSolicitadosRow extends SupabaseDataRow {
  VwDetalhesItensSolicitadosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VwDetalhesItensSolicitadosTable();
