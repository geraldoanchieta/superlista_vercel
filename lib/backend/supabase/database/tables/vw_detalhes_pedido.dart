...
class VwDetalhesPedidoTable extends SupabaseTable<VwDetalhesPedidoRow> {
  @override
  String get tableName => 'vw_detalhes_pedido';

  @override
  VwDetalhesPedidoRow createRow(Map<String, dynamic> data) =>
      VwDetalhesPedidoRow(data);
}

class VwDetalhesPedidoRow extends SupabaseDataRow {
  VwDetalhesPedidoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VwDetalhesPedidoTable();
  ...
  bool? get pedidoEnviado => getField<bool>('pedido_enviado');
  set pedidoEnviado(bool? value) => setField<bool>('pedido_enviado', value);
}
