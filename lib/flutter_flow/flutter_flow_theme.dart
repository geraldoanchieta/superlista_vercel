...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFEC0E33);
  late Color secondary = const Color(0xFFFCAF3F);
  late Color tertiary = const Color(0xFF840A1F);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFEF5753);
  late Color accent2 = const Color(0x7FEF5753);
  late Color accent3 = const Color(0x4CEF5753);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF23CF22);
