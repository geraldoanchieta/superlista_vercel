...
import 'cadastro_restaurante_model.dart';
export 'cadastro_restaurante_model.dart';

class CadastroRestauranteWidget extends StatefulWidget {
  const CadastroRestauranteWidget({super.key});

  static String routeName = 'cadastroRestaurante';
  static String routePath = 'cadastroRestaurante';

  @override
  State<CadastroRestauranteWidget> createState() =>
      _CadastroRestauranteWidgetState();
}

class _CadastroRestauranteWidgetState extends State<CadastroRestauranteWidget> {
  late CadastroRestauranteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroRestauranteModel());
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataT2x1 = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadDataT2x1 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadDataT2x1 =
                                            selectedUploadedFiles.first;
                                        _model.uploadedFileUrl_uploadDataT2x1 =
                                            downloadUrls.first;
                                      });
                                    } else {
                                      safeSetState(() {});
