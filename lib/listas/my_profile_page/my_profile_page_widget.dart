                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            _model.dados =
                                await VwPerfilCompletoUtilizadorTable()
                                    .queryRows(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '(${FFAppState().isRestaurante ? FFAppState().profile.ddd : FFAppState().vendedroe.ddd}) ${FFAppState().isRestaurante ? FFAppState().profile.telefone : FFAppState().vendedroe.telefoneWhatsapp}',
                                maxLines: 1,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
