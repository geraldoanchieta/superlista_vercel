...
import 'bs_cria_produto_pai_model.dart';
export 'bs_cria_produto_pai_model.dart';

class BsCriaProdutoPaiWidget extends StatefulWidget {
  const BsCriaProdutoPaiWidget({super.key});

  @override
  State<BsCriaProdutoPaiWidget> createState() => _BsCriaProdutoPaiWidgetState();
}

class _BsCriaProdutoPaiWidgetState extends State<BsCriaProdutoPaiWidget> {
  late BsCriaProdutoPaiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BsCriaProdutoPaiModel());
