...
import 'catalogovendedor_erro_model.dart';
export 'catalogovendedor_erro_model.dart';

class CatalogovendedorErroWidget extends StatefulWidget {
  const CatalogovendedorErroWidget({
    super.key,
    required this.produto,
  });

  final VwOfertasComAlertaRow? produto;

  @override
  State<CatalogovendedorErroWidget> createState() =>
      _CatalogovendedorErroWidgetState();
}

class _CatalogovendedorErroWidgetState
    extends State<CatalogovendedorErroWidget> {
  late CatalogovendedorErroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CatalogovendedorErroModel());
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        valueOrDefault<String>(
                          widget.produto?.logoRestaurante,
