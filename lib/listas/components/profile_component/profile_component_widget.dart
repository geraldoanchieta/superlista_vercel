...
class _ProfileComponentWidgetState extends State<ProfileComponentWidget> {
  ...
  void initState() {
    ...
    _model.switchValue = FFAppState().esconderfornecedor;
                ...
                children: [
                  ...
                  if (currentUserUid == 'b24a5a55-236c-40e8-b2c6-cfeb5fcb06b0')
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed(ConvidaRestaurranteWidget.routeName);
                      },
                      child: Container(
                        width: double.infinity,
                        decoration: BoxDecoration(
                      ...
                      children: [
                        Switch.adaptive(
                          ...
                          onChanged: (newValue) async {
                            ...
                            if (newValue) {
                              FFAppState().esconderfornecedor = true;
                              safeSetState(() {});
                            } else {
                              FFAppState().esconderfornecedor = false;
                              safeSetState(() {});
                            }
                          },
