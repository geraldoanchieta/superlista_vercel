            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final settinglist = FFAppState().setting.toList();
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, settinglistIndex) {
                          final settinglistItem = settinglist[settinglistIndex];
                          return InkWell(
